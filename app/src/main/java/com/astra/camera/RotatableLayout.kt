 ...
 * vecina.
 *
 * Este ViewGroup en cambio intercambia ancho/alto en `onMeasure` cuando va a
 * rotar 90°/-90°, así que el padre (la fila) sí reserva el espacio real. Es
 * la misma técnica clásica ("RotateLayout") que usan varias apps de cámara
 * de código abierto para orientar controles sin cambiar la orientación de
 * la Activity.
 */
